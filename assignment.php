...
<div class="container-fluid profileHeading">
    <div class="row">
        <div class="col-sm-12">
            <h2 class="sub-header" id="sub-header">Assignments</h2>
            <?php if(isset($_COOKIE['teacher'])||isset($_SESSION['teacher'])){ ?>
            <button class="btn btn-primary" id="addAssignment">Add New</button>

            <form action="<?php echo htmlentities('insert_assignment.php') ?>" id="insertAssignment" name="insertAssignment" method="post" enctype="multipart/form-data">
            ...
            <div class="modal fade" id="myModalEdit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <h2 class="modal-title text-primary text-center" id="myModalLabelEdit">EDIT Assignment</h2>
                        </div>
                        <div class="modal-body">

                            <form action="<?php echo htmlentities('update_assignment.php') ?>" id="updateAssignment" name="updateAssignment" method="post">
                                       <div class="row">
                                ...
                                <div class="col-lg-6">
                                        <div class="form-group">
                                            <label for="updateAssignmentDeadline">Deadline</label>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body  text-center">
                            ...
                            <form action="<?php echo htmlentities('update_assignment.php'); ?>" method="post" id="submitDeleteAssignmentForm">
...
<?php } ?>
            ...
            <table class="table table-responsive table-bordered eventTable">
                ...
                if(isset($_COOKIE['teacher'])||isset($_SESSION['teacher'])) {
                    $assignmentquery = mysqli_query($connection, "Select * from assignment where dept_id='".$teacher['dept_id']."'");
                }
                else if(isset($_COOKIE['student'])||isset($_SESSION['student'])) {
                    $assignmentquery = mysqli_query($connection, "Select * from assignment where dept_batch='".$student['dept_batch']."' AND dept_id='".$student['dept_id']."'");
                }
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $('.td_btnView').click(function(){
                ...
                $('#viewAssignmentFile').html("<a href='assignment/"+dept+"/"+semester+"/"+title+"/"+file+"' download>"+file+"</a>");
