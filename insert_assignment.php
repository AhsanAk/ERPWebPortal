...
if(isset($_COOKIE['teacher'])||isset($_SESSION['teacher'])) {
    ...
    $desp = checkData($_POST['assignmentDesp']);
        ...
        $file_type = trim($file_type);
            ...
            $query = mysqli_query($connection, "INSERT INTO assignment (title, dept_id, dept_batch, semester, deadline, subject, description, assignment_file) VALUES ('$title', '$depart', '$batch', '$semester', '$deadline', '$subject', '$desp', '$title" . '.' . "$file_type' )");
