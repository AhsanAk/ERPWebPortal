...
if(isset($_POST['submitExcelFile'])){
    ...
    foreach ($objPHPExcel->getWorksheetIterator() as $worksheet)
    {
        ...
        for ($row=2; $row<=$highestRow; $row++)
        {
            ...
            $sql = "INSERT INTO book(book_title ,dept_id ,author ,book_copies ,book_pub ,publisher_name ,isbn ,copyright_year ,date_receive ,date_added ,status) VALUES ('".$book_title."', '".$dept_id."', '".$author."', '".$book_copies."', '".$book_pub."', '".$publisher_name."', '".$isbn."', '".$copyright_year."', '".$date_receive."', '".$date_added."', '".$status."')";
			   ...
			   <div class="alert alert-info">
						...
						<h1>Books List</h1>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">
								...
								<p><a href="add_books.php" class="btn btn-info"><i class="icon-plus"></i>&nbsp;Add Books</a>
